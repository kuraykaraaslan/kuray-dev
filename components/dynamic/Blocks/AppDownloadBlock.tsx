  ...
  return (
    <BaseBlock {...baseProps}>
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        {/* Subtitle */}
        {subtitle && (
          <p className="text-lg mb-10 max-w-xl mx-auto text-base-content/70">
            {subtitle}
          </p>
        )}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-3.5 px-6 py-3.5 rounded-xl transition-all hover:scale-105 hover:opacity-90 min-w-[200px] bg-base-300 border border-base-content/15"
          >
            {/* Apple logo */}
            <svg width="28" height="28" viewBox="0 0 814 1000" className="fill-base-content">
        ...
        {/* Optional note */}
        {badgeNote && (
          <p className="mt-6 text-sm text-base-content/35">
            {badgeNote}
          </p>
        )}

        {/* Decorative accent line */}
        <div className="mx-auto mt-12 h-0.5 w-24 rounded-full bg-primary opacity-40" />
      </div>
    </BaseBlock>
  )
}
...
export const AppDownloadBlockDefinition: BlockDefinition = {
  ...
  schema: {
    ...
    headingAccent: { label: 'Heading Accent (colored)', type: 'text' },
  ...
  Component: AppDownloadBlock as unknown as BlockDefinition['Component'],
}
